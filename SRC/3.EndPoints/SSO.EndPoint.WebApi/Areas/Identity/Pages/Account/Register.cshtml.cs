...
namespace SSO.EndPoint.WebApi.Areas.Identity.Pages.Account;
...
public class RegisterModel : PageModel
{
    ...
    private UserIdentity CreateUser()
    {
        try
        {
            return new UserIdentity(new(Input.Username, Input.Email, Input.FirstName, Input.LastName, "100100100100", Input.NationalCode));
        }
        catch
        {
