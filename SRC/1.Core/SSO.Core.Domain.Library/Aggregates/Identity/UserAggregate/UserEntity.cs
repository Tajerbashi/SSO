...
using static SSO.Core.Domain.Library.Aggregates.Identity.UserAggregate.Parameters.UserParameters;

namespace SSO.Core.Domain.Library.Aggregates.Identity.UserAggregate;
